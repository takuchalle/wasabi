...
// ここで定義 https://uefi.org/specs/UEFI/2.11/04_EFI_System_Table.html#id6
#[repr(C)]
...
fn efi_main(image_handle: EfiHandle, efi_system_table: &EfiSystemTable) {
    ...
    for e in memory_map.iter() {
        // CONVENTIONAL_MEMORY が通常のDRAMにあたる
...
fn draw_str_fg<T: Bitmap>(buf: &mut T, x: i64, y: i64, color: u32, str: &str) {
